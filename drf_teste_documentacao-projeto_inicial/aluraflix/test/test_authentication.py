...
class AuthenticationUserTestCase(APITestCase):
    ...
    def test_autenticacao_user_com_credenciais_corretas(self):
        """Teste que verifica a autenticacao de um user com as credenciais coretas"""
